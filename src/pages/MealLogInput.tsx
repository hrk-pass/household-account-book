...
const MealLogInput: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 成功メッセージを表示してリセット
      alert(`${selectedMealType}の記録が完了しました`);
    ...
    <div className="meal-log-input">
      <div className="meal-log-input-container">
        ...
        <form onSubmit={handleSubmit} className="meal-form">
          ...
          <div className="form-actions">
            ...
            <button
              ...
              disabled={isSubmitting || Object.keys(consumptionUpdates).length === 0}
            >
        ...
        <div className="usage-guide">
          <h3>◆ 使用方法</h3>
          <ul>
            <li>使用した食材の消費率を10%単位で選択してください</li>
